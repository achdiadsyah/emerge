				...
				<div class="d-flex flex-column flex-lg-row-fluid py-10" style="background-color:#F5F6F8">
					...
					<div class="d-flex flex-center flex-column flex-column-fluid">
						...
						<div class="w-lg-700px p-10 p-lg-15 mx-auto">
							<!--begin::Form-->
							<form class="my-auto pb-5" novalidate="novalidate" method="post" action="{{ route('investor.detail-update', '2') }}">
								<!--begin::Step 2-->
								<div class="current" data-kt-stepper-element="content">
									...
									<div class="w-100">
										...
										<div class="pb-10 pb-lg-15">
											<!--begin::Title-->
											<h2 class="fw-bolder text-dark">Address Details</h2>
											<!--end::Title-->
											<!--begin::Notice-->
											<div class="text-muted fw-bold fs-6">Tell us about your Address.</div>
											<!--end::Notice-->
										</div>
										<!--end::Heading-->
										<!--begin::Input group-->
										<div class="fv-row mb-7">
											<!--begin::Label-->
											<label class="form-label fw-bolder text-dark fs-6">Province</label>
											<!--end::Label-->
											<!--begin::Input-->
											<select name="province" class="form-select form-select-lg" data-control="select2" data-placeholder="Pick Province" data-allow-clear="true" data-hide-search="true" required>
												<option></option>
										...
										<div class="fv-row mb-7">
											...
											<!--end::Label-->
											<!--begin::Input-->
											<select name="city" class="form-select form-select-lg" data-control="select2" data-placeholder="Pick City" data-allow-clear="true" data-hide-search="true" required>
												<option></option>
												<option value="1">S Corporation</option>
												<option value="1">C Corporation</option>
											</select>
										...
										<!--begin::Input group-->
										<div class="fv-row mb-7">
											<label class="form-label fw-bolder text-dark fs-6">Full Address</label>
											<textarea name="full_address" class="form-control" placeholder="Input your full address" rows="3" required>{{ old('name') }}</textarea>
											@error('full_address')
											<div class="fv-plugins-message-container invalid-feedback">
												<div data-field="full_address" data-validator="notEmpty">
													{{ $message }}
												</div>
											</div>
											@enderror
