				...
				<div class="d-flex flex-column flex-lg-row-fluid py-10" style="background-color:#F5F6F8">
					...
					<div class="d-flex flex-center flex-column flex-column-fluid">
						...
						<div class="w-lg-700px p-10 p-lg-15 mx-auto">
							<!--begin::Form-->
							<form class="my-auto pb-5" novalidate="novalidate" method="post" action="{{ route('investor.detail-update', '3') }}">
								<!--end::Step 2-->
								<!--begin::Step 3-->
								<div class="current" data-kt-stepper-element="content">
									...
									<div class="w-100">
										...
										<div class="pb-10 pb-lg-12">
											<!--begin::Title-->
											<h2 class="fw-bolder text-dark">Investment Details</h2>
											<!--end::Title-->
											<!--begin::Notice-->
											<div class="text-muted fw-bold fs-6">Setup your investment plan.</div>
											<!--end::Notice-->
										</div>
										<!--end::Heading-->
										<!--begin::Input group-->
										<div class="fv-row mb-7">
											<!--begin::Label-->
											<label class="form-label fw-bolder text-dark fs-6">Will you be investing as an individual?</label>
											<!--end::Label-->
											<!--begin::Input-->
											<select name="investing_as_individual" class="form-select form-select-lg form-select" data-control="select2" data-placeholder="Pick Country" data-allow-clear="true" data-hide-search="true">
										...
										<div class="fv-row mb-7">
											<!--begin::Label-->
											<label class="form-label fw-bolder text-dark fs-6">How much is your annual income?</label>
											<!--end::Label-->
											<!--begin::Input-->
											<select name="annual_income_range" class="form-select form-select-lg form-select" data-control="select2" data-placeholder="Pick Country" data-allow-clear="true" data-hide-search="true">
												<option value="1">More than USD 35,000</option>
											</select>
											<!--end::Input-->
										</div>
										<!--end::Input group-->
										...
										<div class="fv-row mb-7">
											<!--begin::Label-->
											<label class="form-label fw-bolder text-dark fs-6">How much are you hoping to invest to startup in eMerge throughout the year?</label>
											<!--end::Label-->
											<!--begin::Input-->
											<select name="expected_annual_investation" class="form-select form-select-lg form-select" data-control="select2" data-placeholder="Pick Country" data-allow-clear="true" data-hide-search="true">
										...
										<div class="fv-row mb-7">
											<!--begin::Label-->
											<label class="form-label fw-bolder text-dark fs-6">What are your reasons for joining eMerge? </label>
											<!--end::Label-->
											<!--begin::Input-->
											<select name="expected_annual_investation" class="form-select form-select-lg form-select" data-control="select2" data-placeholder="Pick Country" data-allow-clear="true" data-hide-search="true">
												<option value="1">Generating financial returns for your portfolio</option>
											</select>
											<!--end::Input-->
										</div>
										<!--end::Input group-->
