				...
				<div class="d-flex flex-column flex-lg-row-fluid py-10">
							...
							<form class="form w-100" novalidate="novalidate" id="kt_sign_up_form">
								...
								<div class="text-center">
									...
									<div class="d-flex flex-stack mb-2">
										...
										<!--end::Label-->
										<!--begin::Link-->
										<a href="{{ url('/investor/password-reset') }}" class="link-primary fs-6 fw-bolder">Forgot Password ?</a>
										<!--end::Link-->
									</div>
									<!--end::Wrapper-->
									<!--begin::Submit button-->
					...
					<div class="d-flex flex-center flex-wrap fs-6 p-5 pb-0">
                        <div class="mb-10 text-center">
                            <!--begin::Login-->
                            <div class="text-gray-400 fw-bold fs-4">Don't Have Account? <a href="{{ url('/investor/register') }}" class="ms-1 link-primary">Sign Up Now</a>
                            <!--end::Login-->
                        </div>
					</div>
					<!--end::Footer-->
